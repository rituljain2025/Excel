...
export class FormulaEvaluator {
   ...
   */
  constructor(
    private getCellData: (row: number, col: number) => string | undefined
  ) {}
   ...
   */
  private handleFunction(formula: string, func: string): string {
   ...
   */
  private indexToCellLabel(row: number, col: number): string {
    let columnLabel = "";
    let tempCol = col;
   ...
   */
  private cellLabelToIndex(label: string): { row: number, col: number } {
